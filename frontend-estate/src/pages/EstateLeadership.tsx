...
const EstateLeadership: React.FC = () => {
  ...
  const saveLeader = (leader: any) => {
    ...
    api
      .patch(`/api/estates/${estateId}/leadership/${leader.id}/`, formData, {
  ...
  const addLeader = () => {
    ...
    api
      .post(`/api/estates/${estateId}/leadership/`, formData, {
        headers: { "Content-Type": "multipart/form-data" },
      })
      .then(() => {
        alert("Leader added");
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <input
                  ...
                  onChange={(e) =>
                    handleChange(leader.id, "position", e.target.value)
                  }
                ...
                <input
                  ...
                  value={leader.email}
                  onChange={(e) =>
                    handleChange(leader.id, "email", e.target.value)
                  }
                  placeholder="Email"
                />
                <input
                  ...
                  onChange={(e) =>
                    handleChange(leader.id, "phone_number", e.target.value)
                  }
                  placeholder="Phone"
                />
                <input
                  ...
                  value={leader.bio || ""}
                  onChange={(e) =>
                    handleChange(leader.id, "bio", e.target.value)
                  }
                  placeholder="Bio"
                />
                <input
                  ...
                  onChange={(e) =>
                    handleChange(leader.id, "order", e.target.value)
                  }
                  placeholder="Order"
                />
              </div>
        ...
        <div className="border p-4 rounded-md shadow-sm bg-white space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <select
              ...
              onChange={(e) =>
                setNewLeader({ ...newLeader, userId: e.target.value })
              }
            >
            ...
            <input
              ...
              onChange={(e) =>
                setNewLeader({ ...newLeader, position: e.target.value })
              }
              placeholder="Position"
            />
            <input
