        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-6 max-w-3xl text-xl text-gray-600 mx-auto">
              Everything you need to efficiently manage residential estates with
              modern technology
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Generate visitor codes with automatic expiry, track visitor entries, and maintain estate security with real-time monitoring.",
              ...
              },
              {
                ...
                description:
                  "Manage estate dues, track payments, and generate comprehensive financial reports with automated reminders.",
              ...
              },
              {
                ...
                description:
                  "Maintain comprehensive resident records, approve new residents, and manage resident access seamlessly.",
              ...
              },
              {
                ...
                description:
                  "Residents can generate time-limited visitor codes instantly for seamless and secure guest access.",
              ...
              },
              {
                ...
                description:
                  "Send important announcements to all residents and notify about upcoming dues and events.",
              ...
              },
              {
                ...
                description:
                  "Role-specific dashboards for administrators and residents with relevant, actionable information.",
              ...
              >
                <div
                  className={`inline-flex items-center justify-center h-16 w-16 rounded-2xl bg-gradient-to-r ${feature.color} text-white mb-6 group-hover:scale-110 transition-transform duration-300`}
                >
          ...
          <div className="lg:flex lg:items-center lg:justify-between lg:gap-16">
            <div className="lg:w-1/2">
              ...
              <p className="mt-6 text-xl text-gray-600">
                Powerful tools to efficiently manage your estate operations with
                precision and ease
              </p>
                ...
                {[
                  {
                    ...
                    description:
                      "Review and approve new resident registrations with comprehensive verification",
                  },
                  {
                    title: "Payment Verification",
                    description:
                      "Verify payment evidence uploaded by residents with automated tracking",
                  },
                  {
                    title: "Financial Reports",
                    description:
                      "Generate comprehensive payment reports and analytics for better insights",
                  },
                  {
                    title: "Estate Profile Management",
                    description:
                      "Update estate information and leadership details in real-time",
                  },
                ].map((item, index) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:flex lg:items-center lg:justify-between lg:gap-16 flex-row-reverse">
            <div className="lg:w-1/2">
              ...
              <p className="mt-6 text-xl text-gray-600">
                Convenient features designed to enhance your living experience
                ...
                {[
                  {
                    ...
                    description:
                      "Generate time-limited visitor codes instantly with smart notifications",
                  },
                  {
                    title: "Easy Payments",
                    description:
                      "Pay estate dues and upload payment evidence with automated confirmations",
                  },
                  {
                    title: "Profile Management",
                    description:
                      "Update your personal information and preferences effortlessly",
                  },
                  {
                    title: "Estate Information",
                    description:
                      "Access important estate details, announcements, and community updates",
                  },
                ].map((item, index) => (
                  <div key={index} className="flex items-start group">
                    <div className="flex-shrink-0 mt-1">
          ...
          {loading ? (
                  ...
                  <div className="p-8">
                    <div className="flex items-center mb-6">
                      <div className="flex-shrink-0">
                        ...
                        <div
                          className={`${estate.logo ? "hidden" : ""} h-16 w-16 rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}
                        >
            ...
            <div className="mt-16 text-center">
              ...
              <p className="text-gray-500 mb-6">
                Be the first estate to join our platform!
              </p>
              <Link
                to="/register"
          ...
          <div className="lg:flex lg:items-center lg:justify-between">
            <div>
              ...
              <p className="mt-6 text-xl text-blue-100 max-w-2xl">
                Transform your estate operations with our comprehensive
                management platform.
              </p>
            </div>
