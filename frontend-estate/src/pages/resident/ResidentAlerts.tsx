          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-6">
            ...
            <div className="flex items-center space-x-3 sm:space-x-4">
              <div className="bg-white bg-opacity-20 rounded-full p-2.5 sm:p-3">
                <AlertTriangleIcon size={28} className="sm:w-8 sm:h-8" />
              </div>
              ...
              <div>
                ...
                <p className="opacity-90 text-sm sm:text-base">
                  Send immediate alerts to estate management and security
                </p>
              </div>
            </div>
            ...
            <button
              ...
              className="w-full sm:w-auto text-center bg-white text-red-600 px-5 py-2.5 sm:px-6 sm:py-3 
                 rounded-lg font-semibold hover:bg-red-50 transition-colors shadow-md sm:shadow-lg"
            >
              Send Alert
            </button>
          </div>
            ...
            {loading ? (
              ...
              <div className="p-8 text-center">
                ...
                <p className="text-sm text-gray-400 mt-1">
                  Use the button above to send an emergency alert
                </p>
              </div>
            ) : (
              <div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                      <p className="text-sm text-yellow-800">
                        ...
                        immediately to estate management and security personnel
                        via email and SMS.
                      </p>
                    </div>
