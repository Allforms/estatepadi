          ...
          <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 bg-gradient-to-r from-red-600 to-red-700 text-white p-6 rounded-t-xl">
              ...
              <p className="mt-2 opacity-90">
                Select the type of emergency to alert all residents and security
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
                 ...
                 <div className="grid grid-cols-2 gap-3">
                  {alertTypes.map((type) => (
                    <button
                      ...
                      type="button"
                      onClick={() =>
                        setFormData({ ...formData, alert_type: type.value })
                      }
              ...
              {formData.alert_type === "other" && (
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, other_reason: e.target.value })
                    }
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                <p className="text-sm text-yellow-800">
                  <strong>Note:</strong> This alert will be sent immediately to
                  estate residents and security personnel via email and SMS.
                </p>
              </div>
