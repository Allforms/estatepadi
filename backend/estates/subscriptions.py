...
def renew_subscription(request):
    """
    Renew or pay again for a subscription (works for active, cancelled, or inactive subscriptions)
    This allows users to make a new payment for their current plan
    """
    plan_id = request.data.get('plan_id')
    reference = request.data.get('reference')
